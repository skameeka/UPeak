(function () {
  ...
  var DICT = {
    ru: {
      ...
      "planner.feedback.hint": "Короткий опрос после завершения использования. Ответы помогут нам понять, что было полезно и что улучшить.",
      "planner.feedback.usefulness": "Насколько полезным оказался продукт?",
      "planner.feedback.usefulnessPh": "1 — совсем не полезен, 5 — очень полезен",
      "planner.feedback.stateHelp": "Помог ли продукт лучше понимать своё состояние?",
      "planner.feedback.planningHelp": "Помог ли продукт лучше распределять нагрузку?",
      "planner.feedback.continue": "Хотел бы ты продолжить использовать продукт?",
      "planner.feedback.yes": "Да",
      "planner.feedback.partially": "Частично",
      "planner.feedback.no": "Нет",
      "planner.feedback.mostUseful": "Что было самым полезным?",
      "planner.feedback.improvements": "Что нужно улучшить?",
      "planner.feedback.missing": "Если бы продукт исчез завтра, чего бы тебе не хватало?",
    ...
    en: {
      ...
      "planner.feedback.hint": "A short survey after you finish using the product. Your answers help us understand what was useful and what to improve.",
      "planner.feedback.usefulness": "How useful was the product?",
      "planner.feedback.usefulnessPh": "1 — not useful at all, 5 — very useful",
      "planner.feedback.stateHelp": "Did the product help you better understand your state?",
      "planner.feedback.planningHelp": "Did the product help you better distribute your workload?",
      "planner.feedback.continue": "Would you like to keep using the product?",
      "planner.feedback.yes": "Yes",
      "planner.feedback.partially": "Partially",
      "planner.feedback.no": "No",
      "planner.feedback.mostUseful": "What was the most useful?",
      "planner.feedback.improvements": "What should be improved?",
      "planner.feedback.missing": "If the product disappeared tomorrow, what would you miss?",
